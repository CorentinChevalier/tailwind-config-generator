...
<div class='flex flex-row items-center my-2 gap-4'>
    <div class='flex flex-1 flex-row items-center border rounded-lg gap-2'>
        <input type='text' bind:value={currentName} class='w-full !m-0 !border-none' on:input={(e) => handleUpdate(e.currentTarget.value, currentValue, index)} placeholder='type your custom color name and choose your color' />
